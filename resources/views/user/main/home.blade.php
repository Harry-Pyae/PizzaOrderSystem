                    ...
                    <div class="row" id="dataList">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                            <div class="product-item bg-light mb-4" id="myForm">
                                <div class="product-img position-relative overflow-hidden">
                                    <img class="img-fluid w-100" style="height: 300px;" src="{{asset('storage/products/'.$p->image)}}" alt="">
                        ...
                        <div class="p-1 mt-3">
                            <h2 class="text-center text-white fs-1">
                                <span class=" bg-info p-3 rounded shadow-sm"> There is no product here! <i class="fa-solid fa-face-sad-tear"></i></span>
                            </h2>
                        </div>
                        @endif
                    </div>
